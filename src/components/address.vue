      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul> 
                <li v-for="(item, index) in filterAddress" :key="item.addressId" :class="{'check': currentIndex == index}" @click="currentIndex = index">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-set-default" v-if="!item.isDefault">
                    <a href="javascript:;" class="addr-set-default-btn" @click="setDefault(index)"><i>设为默认</i></a>
                  </div>
            ...
            <div class="shipping-addr-more">
              <a class="addr-more-btn up-down-btn" href="javascript:" @click="addressStep+=3">
                more
                <i class="i-up-down">
          ...
          <div class="shipping-method-wrap">
            <div class="shipping-method">
              <ul>
                <li :class="{'check':sendMethod}" @click="sendMethod=true">
                  <div class="name">标准配送</div>
                  <div class="price">Free</div>
                </li>
                <li :class="{'check':!sendMethod}" @click="sendMethod=false">
  ...
  export default {
    ...
    computed: {
      filterAddress: function () {
        return this.addressList.slice(0,this.addressStep);
      }
    },
    methods: {
      fetchData: function () {
        var self= this;
        this.$http.get("./src/assets/data/address.json").then(res => {
